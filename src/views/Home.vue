<template>
  <div class="home">
    ...
    <button @click="showBorderSituation = !showBorderSituation">
      切换事件监听
    </button>
...
import entranceJs from "@/utils/entranceJs";
...
export default {
  ...
  provide() {
    //很多后代组件使用的情况， 注入属性或方法，中inject来使用，非响应
    return {
      name: function () {
